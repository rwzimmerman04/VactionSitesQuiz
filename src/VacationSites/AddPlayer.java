...
/**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*<pre>
 * Class        AddPlayer.java
 * Description  A jDialog that holds input fields for adding a player to the list.
 * Project      Project 1 -- Vacation Sites Quiz
 * Platform     jdk 1.8.0_241; NetBeans IDE 18; PC Windows 10
 * Course       CS 143
 * Hours        50 minutes
 * Date         10/6/2023
 * History Log  10/6/2023, 10/7/2023
...
public class AddPlayer extends javax.swing.JDialog {
     ...
     * Description  Create an instance of the AddPlayer jDialog.
     * Date         10/6/2023
    ...
    *</pre>
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    public AddPlayer(BinarySearchTree playersBST) 
    {
        this();
    ...
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    ...
    private void initComponents() {
        ...
        titleJLabel.setText("Add Player Details");
    ...
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    private void saveJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveJButtonActionPerformed
        if(allFieldsFilled())
        {
            ...
            if(total >= correct)
            {
                newPlayer = new Player(name, age, correct, total);
